...
class StaticFeatureDatasetConfig:
    ...
    norm_ori_max: List[float] = field(default_factory=lambda: [0.0533, 0.7664, 0.7560, 0.1297, 0.0942, 0.1288, 0.2982, 0.6165, 0.3286,
    ...
    norm_ori_min: List[float] = field(default_factory=lambda: [-0.0333, -0.0269, -0.1450, -0.2116, -0.0057, -0.0115, -0.0888, -1.0891,
    ...
    norm_map_scale: List[float] = field(default_factory=lambda: [23.0920,  2.5212,  2.2197,  5.8597, 20.0263, 14.2639,  5.1676,  1.1726,
         ...
         1.1202,  1.2595])
    norm_remap_scale: List[float] = field(default_factory=lambda: [0.0433, 0.3966, 0.4505, 0.1707, 0.0499, 0.0701, 0.1935, 0.8528, 0.3482,
